		...
		if (isset($pxml->products->product)) {
			foreach($pxml->products->product as $item) {		
				...
				if ($skipit == 0) {
					...
					if(!empty($item->upc)) {$unique = $item->upc;} elseif(!empty($item->sku)) {$unique = $item->sku;} elseif(!empty($item->isbn)) {$unique = $item->isbn;}
		...
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 
			...
			<tr valign="top"> 
				...
				<select name="wpr_commissionjunction_sortby" id="wpr_commissionjunction_sortby">
					...
					<option value="salePrice" <?php if($options['wpr_commissionjunction_sortby']=="salePrice"){_e('selected');}?>><?php _e("salePrice","wprobot") ?></option>
			...
			<tr valign="top"> 
				...
				<td>
				<select name="wpr_commissionjunction_lang" id="wpr_commissionjunction_lang">
					<option value="en" <?php if($options['wpr_commissionjunction_lang']=="en"){_e('selected');}?>><?php _e("English","wprobot") ?></option>
					<option value="de" <?php if($options['wpr_commissionjunction_lang']=="de"){_e('selected');}?>><?php _e("German","wprobot") ?></option>
					<option value="fr" <?php if($options['wpr_commissionjunction_lang']=="fr"){_e('selected');}?>><?php _e("French","wprobot") ?></option>
					<option value="it" <?php if($options['wpr_commissionjunction_lang']=="it"){_e('selected');}?>><?php _e("Italian","wprobot") ?></option>
					<option value="es" <?php if($options['wpr_commissionjunction_lang']=="es"){_e('selected');}?>><?php _e("Spanish","wprobot") ?></option>
					<option value="nl" <?php if($options['wpr_commissionjunction_lang']=="nl"){_e('selected');}?>><?php _e("Dutch","wprobot") ?></option>
					<option value="cn" <?php if($options['wpr_commissionjunction_lang']=="cn"){_e('selected');}?>><?php _e("Chinese","wprobot") ?></option>
					<option value="tw" <?php if($options['wpr_commissionjunction_lang']=="tw"){_e('selected');}?>><?php _e("Taiwanese","wprobot") ?></option>								
				</select>
			</td> 
			</tr>	
			-->
