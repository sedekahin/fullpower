...
-->
	...
	<!--<div class="updated" style="margin-top: 20px;">
		<h3 style="margin: 10px 0 0 0;"><?php _e("WP Robot Control Center","wprobot") ?></h3>
		<p><b><?php _e("PW Code for this website:","wprobot") ?> <span style="color:#cc0000;font-size:120%;background:#FFFBCC;padding:1px;"><?php echo get_option("wpr_cron"); ?></span></b> - <?php _e('you can use this unique code instead of your Wordpress login password to add this blog to the <a target="_blank" href="http://cc.wprobot.net/?ref=wprc">WP Robot Control Center</a>.',"wprobot") ?></p>
		<p><?php _e("The WP Robot Control Center is a service that allows you to control and manage any number of Wordpress weblogs remotely at the same time!","wprobot") ?><br/><a target="_blank" style="font-size:120%;" href="http://cc.wprobot.net/?ref=wprc"><strong><?php _e("Learn more &rarr;","wprobot") ?></strong></a></p>
	</div>-->		
	
	<div class="updated" style="margin-top: 20px;">
		<h3 style="margin: 10px 0 0 0;"><?php _e("Remotely Manage WP Robot with CMS Commander for Free!","wprobot") ?></h3>
		<p><?php _e("CMS Commander is an online service that lets you remotely manage and control any number of Wordpress websites and the WP Robot plugin from a central account to <strong>save lots of time</strong>. CMS Commander is currently in <strong>free and open beta</strong>.","wprobot") ?><br/><a target="_blank" style="font-size:120%;" href="http://cmscommander.com/"><strong><?php _e("Learn More and Sign Up Now &rarr;","wprobot") ?></strong></a></p>
	</div>		
	...
	<div class="updated" style="margin-top: 20px;">
		...
		<div style="float:left;">
			...
			<p><a target="_blank" href="http://wpshoppingpages.com/">WP Shopping Pages</a> | <a target="_blank" href="http://paydotcom.net/r/96144/thoefter/26522731/">TheBestSpinner Special Discount</a> | <a target="_blank" href="http://paydotcom.net/r/114163/thoefter/26909274/">SpinnerChief Special Discount</a> | <a target="_blank" href="http://542c4iv7ejm1cq6-snxenhk6kz.hop.clickbank.net/">SpinChimp Special Discount</a></p>
		</div>
