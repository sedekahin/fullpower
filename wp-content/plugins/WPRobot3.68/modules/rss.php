		...
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 
			<tr valign="top"> 
				...
				<select name="wpr_rss_content" id="wpr_rss_content">
					...
					<option value="trunc" <?php if($options['wpr_rss_content']=="trunc"){_e('selected');}?>><?php _e("Always truncate post to first 300 characters even if full content available.","wprobot") ?></option>					
				</select>
			</td> 
			</tr>	
			<tr valign="top"> 
